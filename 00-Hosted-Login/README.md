# Auth0 Angular Hosted Login

This sample demonstrates how to add authentication to an Angular application using Auth0's Lock widget using Auth0's hosted login page. The sample uses the Angular CLI.
